...
public class UserService {
	...
	public UserService(ValidateRequest validate,UserRepository userRepo,AddressRepository addressRepo,PasswordEncoder passwordEncoder,JwtService jwtService) {
